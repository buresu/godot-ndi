...
void NdiReceiver::_bind_methods() {
    ClassDB::bind_method(D_METHOD("set_source_name", "name"), &NdiReceiver::set_source_name);
    ClassDB::bind_method(D_METHOD("get_source_name"), &NdiReceiver::get_source_name);
    ClassDB::bind_method(D_METHOD("set_bandwidth", "bandwidth"), &NdiReceiver::set_bandwidth);
    ClassDB::bind_method(D_METHOD("get_bandwidth"), &NdiReceiver::get_bandwidth);
    ClassDB::bind_method(D_METHOD("set_target_texture", "texture"), &NdiReceiver::set_target_texture);
    ClassDB::bind_method(D_METHOD("get_target_texture"), &NdiReceiver::get_target_texture);
    ...
    ClassDB::bind_method(D_METHOD("_update_texture"), &NdiReceiver::_update_texture);
    ...
    ADD_PROPERTY(PropertyInfo(Variant::OBJECT, "target_texture", PROPERTY_HINT_RESOURCE_TYPE, "ImageTexture"), "set_target_texture", "get_target_texture");

    BIND_ENUM_CONSTANT(NdiInputStream::HIGHEST);
    BIND_ENUM_CONSTANT(NdiInputStream::LOWEST);
}

NdiReceiver::NdiReceiver() : _is_running(true), _bandwidth(NdiInputStream::HIGHEST) {
    ...
    RenderingServer::get_singleton()->connect("frame_pre_draw", Callable(this, "_update_texture"));
}
...
NdiReceiver::~NdiReceiver() {
    ...
    RenderingServer::get_singleton()->disconnect("frame_pre_draw", Callable(this, "_update_texture"));
}
...
String NdiReceiver::get_source_name() const {
    return _source_name;
}
